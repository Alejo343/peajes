    ...
    <div
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            ...
            <form action="{{ route('upload') }}" method="POST" enctype="multipart/form-data"
                ...
                @csrf
                <h2 class="text-2xl font-semibold mb-6 text-center">Subir y modificar archivo Word</h2>

                <!-- Seleccionar peaje -->
                <div class="form-group">
                    <label for="option-toll">Elige el Peaje:</label>
                    <select id="option-toll" name="option-toll" class="form-control">
                        <option value="CENCAR">Cencar</option>
                ...
                <div class="mb-4">
                    <label for="code" class="block text-gray-700 font-medium mb-2">Codigo:</label>
                ...
                <div class="text-center">
                    <button type="submit"
                        class="w-full bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded-lg transition duration-200 ease-in-out">
                        Subir y modificar
                    </button>
                </div>
